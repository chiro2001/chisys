...
*/
static void _SetPixelIndex(GUI_DEVICE * pDevice, int x, int y, long unsigned int PixelIndex) {
    //
    ...
    GUI_USE_PARA(PixelIndex);
    {
      ...
      // TBD by customer...
      //
      // ili9488_set_pixel((uint16_t)x, (uint16_t)y, (uint16_t)PixelIndex);
    }
...
*   that no check on the parameters needs to be performed.
*/
static long unsigned int _GetPixelIndex(GUI_DEVICE * pDevice, int x, int y) {
